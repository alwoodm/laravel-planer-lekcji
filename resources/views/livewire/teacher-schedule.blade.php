<div>
                            ...
                            <td class="border border-gray-300 p-1">
                                @if (isset($weeklySchedule[$day][$timeSlot->id]))
                                    <div class="h-full w-full p-2 bg-white border rounded-sm shadow-sm">
                                        ...
                                        <div class="text-xs text-gray-600">Klasa: {{ $weeklySchedule[$day][$timeSlot->id]->class->name }}</div>
    ...
    <div class="text-right">
        <a href="{{ route('schedules.teacher', $teacher->id) }}" class="text-blue-600 hover:text-blue-800 underline">
            Pełny plan lekcji
        </a>
    </div>
</div>
